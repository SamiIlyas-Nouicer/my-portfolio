...
const Project = ({ technologies, image, description }) => {
  return (
    <div
      className="flex flex-col justify-between border  w-5/12 rounded border-purple-950 bg-no-repeat bg-cover bg-slate-950
     hover:scale-110 hover:shadow-lg transition transform duration-200 hover:m-8"
    >
